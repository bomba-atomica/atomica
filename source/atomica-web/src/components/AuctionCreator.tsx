...
export function AuctionCreator({ account }: AuctionCreatorProps) {
    ...
    return (
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h2 className="text-xl font-bold mb-4 text-blue-400">2. Create Auction</h2>
            <div className="space-y-4">
                ...
                <div>
                    <label className="block text-gray-400 text-sm mb-1">Min Price (USD)</label>
                    <input
                        type="number"
                        value={minPrice}
                ...
                <div>
                    <label className="block text-gray-400 text-sm mb-1">Duration (seconds)</label>
                    <input
                        type="number"
                        value={duration}
                ...
                <button
                    ...
                    disabled={loading}
                    className={`w-full py-2 rounded font-bold transition ${loading ? "bg-gray-600 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"
                        }`}
                >
