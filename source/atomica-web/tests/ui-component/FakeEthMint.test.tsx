 ...
 * @description UI test for minting FakeETH on the Ethereum testnet.
 *
 * Tests that a button component can:
 ...
 *
 * Note: Because FAKE_ETH_ADDRESS is a module-level constant baked from chain-config
 * at import time, this test renders an inline component that accepts the contract
 * address as a prop and uses ethers directly — rather than importing Faucet.tsx.
 */
...
import { FAKE_ETH_ABI } from "../../src/lib/ethereum/abis";
