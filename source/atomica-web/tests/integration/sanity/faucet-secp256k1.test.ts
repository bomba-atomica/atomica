...
describe.sequential('SECP256k1 Account Faucet Funding', () => {
    ...
    it('should fund a SECP256k1 account via faucet', async () => {
        ...
        console.log(`Account authentication key: ${accountInfo.authentication_key}`);
    ...
    it('should fund SECP256k1 account created from Ethereum private key', async () => {
        ...
        console.log("Step 1: Creating SECP256k1 account from Ethereum private key...");
        const ethereumPrivateKeyHex = "0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890";
        ...
        console.log("Note: Address differs from Ethereum due to SHA3-256 vs Keccak-256");
