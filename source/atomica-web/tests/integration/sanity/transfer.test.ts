...
describe.sequential('Simple APT Transfer', () => {
    ...
    it('should perform a simple transfer', async () => {
        ...
        const aliceInitialBalance = await aptos.getAccountAPTAmount({ accountAddress: alice.accountAddress });
        const bobInitialBalance = await aptos.getAccountAPTAmount({ accountAddress: bob.accountAddress });
        ...
        const aliceFundedBalance = await aptos.getAccountAPTAmount({ accountAddress: alice.accountAddress });
        ...
        const aliceFinalBalance = await aptos.getAccountAPTAmount({ accountAddress: alice.accountAddress });
        const bobFinalBalance = await aptos.getAccountAPTAmount({ accountAddress: bob.accountAddress });
