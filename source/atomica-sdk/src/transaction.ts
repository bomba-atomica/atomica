import { Serializer, AccountAuthenticator, AccountAddress, Aptos } from "@aptos-labs/ts-sdk";
...
export async function simulateNativeTransaction(aptos: Aptos, preparedTx: PreparedTransaction) {
    try {
...
export async function submitPreparedTransaction(aptos: Aptos, preparedTx: PreparedTransaction) {
...
export async function submitNativeTransaction(
    ...
    if ("auth" in payload && "transaction" in payload) {
        return submitPreparedTransaction(aptos, payload as PreparedTransaction);
    }
