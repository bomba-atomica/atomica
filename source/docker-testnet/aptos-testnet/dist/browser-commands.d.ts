...
declare module "vitest/browser" {
    interface BrowserCommands {
        ...
        teardownLocalnet(): Promise<{
            success: boolean;
        }>;
        deployContracts(): Promise<{
            success: boolean;
        }>;
        fundAccount(address: string, amount?: number): Promise<{
            success: boolean;
            txHash: string;
        }>;
        setupDualChainTestnet(): Promise<DualChainTestnetInfo>;
        teardownDualChainTestnet(): Promise<{
            success: boolean;
        }>;
 ...
 */
export declare const setupLocalnetCommand: BrowserCommand<[]>;
/**
 ...
 * @returns Promise resolving to { success: true }
 */
export declare const teardownLocalnetCommand: BrowserCommand<[]>;
/**
 ...
 */
export declare const deployContractsCommand: BrowserCommand<[]>;
/**
 ...
 * EXECUTION: Node.js (browser can't start Docker containers)
 */
export declare const setupDualChainTestnetCommand: BrowserCommand<[]>;
/**
