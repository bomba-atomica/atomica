...
// Find source directory by going up from aptos-testnet/src
const SOURCE_DIR = pathResolve(TEST_SETUP_DIR, "../../../");
/**
...
export async function deployContracts() {
    ...
    await testnet.deployContracts({
        ...
        fundAmount: 10000000000n, // 100 APT
    });
 ...
 */
export function setTestnet(testnetInstance) {
