...
export function Step8Monitor({ amount, minPrice, auctionEndTime, unlockTime, sellerAddress, windowId, pairBcs, onCancelAndUnlock, loading, error, }) {
    ...
    const priceFormatted = minPrice
        ...
        : "—";
    return (_jsxs("div", { className: "flex flex-col gap-4", children: [_jsxs("div", { className: "rounded border border-zinc-800 bg-zinc-950/60 p-4 flex flex-col gap-3", children: [_jsxs("div", { className: "flex justify-between text-sm", children: [_jsx("span", { className: "text-zinc-500", children: "Locked amount" }), _jsx("span", { className: "text-zinc-200 font-mono", children: amountFormatted })] }), _jsxs("div", { className: "flex justify-between text-sm", children: [_jsx("span", { className: "text-zinc-500", children: "Min price" }), _jsx("span", { className: "text-zinc-200 font-mono", children: priceFormatted })] }), sellerAddress && (_jsxs("div", { className: "flex justify-between text-sm", children: [_jsx("span", { className: "text-zinc-500", children: "Seller address" }), _jsx("span", { "data-testid": "auction-seller-address", className: "text-zinc-200 font-mono text-xs truncate max-w-[180px]", title: sellerAddress, children: sellerAddress })] })), _jsx("div", { className: "h-px bg-zinc-800" }), _jsxs("div", { className: "flex justify-between text-sm", children: [_jsx("span", { className: "text-zinc-500", children: "Auction closes in" }), _jsx("span", { "data-testid": "auction-countdown", className: `font-mono ${ended ? "text-zinc-500" : "text-zinc-200"}`, children: auctionEndTime ? formatDuration(remaining) : "—" })] }), _jsxs("div", { className: "flex justify-between text-sm", children: [_jsx("span", { className: "text-zinc-500", children: "Status" }), _jsx("span", { "data-testid": "auction-status-badge", className: `text-xs px-2 py-0.5 rounded ${ended ? "bg-zinc-700 text-zinc-400" : "bg-zinc-800 text-zinc-300"}`, children: ended ? "Settled" : "Active" })] })] }), ended && windowId != null && pairBcs != null && (_jsx(SettleButton, { windowId: windowId, pairBcs: pairBcs, auctionEndTime: auctionEndTime, onSettled: (wid, cp) => recordSettlement(wid.toString(), cp) })), ended && windowId != null && pairBcs != null && (_jsx(ClaimButton, { windowId: windowId, pairBcs: pairBcs, sellerAddress: sellerAddress ?? undefined })), feeRebate.ready && feeRebate.isWinner && (_jsx(FeeRebateDisplay, { rebateAmount: feeRebate.rebateAmount, feeAmount: feeRebate.feeAmount })), _jsxs("div", { className: "mt-2", children: [_jsx("h3", { className: "text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-2", children: "Settlement History" }), _jsx(BidHistory, { entries: bidHistoryEntries })] }), canUnlock && (_jsxs("div", { className: "flex flex-col gap-2", children: [_jsx("p", { className: "text-xs text-zinc-500", children: "Your lock period has expired. You may cancel and reclaim your tokens." }), _jsx("button", { onClick: onCancelAndUnlock, disabled: loading, className: `w-full py-2 rounded text-sm font-semibold border transition-colors ${loading
