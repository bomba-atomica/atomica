 ...
 */
export function ClaimButton({ sellerAddress }) {
    ...
    return (_jsxs("div", { className: "flex flex-col gap-2", children: [_jsxs("div", { className: "flex gap-2", children: [_jsx("button", { "data-testid": "claim-button", onClick: handleClaim, disabled: claimDisabled, className: `flex-1 py-2 rounded font-semibold text-sm transition-colors ${claimDisabled
