...
export function TestnetSelector() {
    ...
    return (_jsx("span", { className: "text-xs font-mono text-zinc-400 border border-zinc-800 rounded px-2 py-1.5 bg-zinc-900/60", children: host }));
}
//# sourceMappingURL=TestnetSelector.js.map