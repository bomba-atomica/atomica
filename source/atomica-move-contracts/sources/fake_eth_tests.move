...
module atomica::fake_eth_tests {
    ...
    public fun test_multiple_users_mint(deployer: &signer, user1: &signer, user2: &signer) {
        ...
        fake_eth::mint(deployer, user1_addr, mint_amount1);
        fake_eth::mint(deployer, user2_addr, mint_amount2);
    ...
    public fun test_multiple_mints_accumulate(deployer: &signer, user: &signer) {
        ...
        let user_addr = signer::address_of(user);
        fake_eth::mint(deployer, user_addr, mint_amount1);
        fake_eth::mint(deployer, user_addr, mint_amount2);
    ...
    public fun test_zero_mint(deployer: &signer, user: &signer) {
        ...
        // Mint zero amount
        let user_addr = signer::address_of(user);
        fake_eth::mint(deployer, user_addr, 0);
