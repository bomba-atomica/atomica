 ...
 *
 * This file is consumed by atomica-web-ui/tests/** at relative path
 * ../../test-utils/browser-utils/EthereumMintMock.
 *
 * The canonical source lives in:
 *   source/docker-testnet/aptos-testnet/src/browser-utils/EthereumMintMock.ts
 *
...
// Window.ethereum typing is provided by tests/integration/fixtures/wallet-mock.ts
 ...
 */
export async function setupEthereumMintMock(options: EthereumMintMockOptions): Promise<string> {
